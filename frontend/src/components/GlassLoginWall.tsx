              ...
              >
                ...
                <div>
                  ...
                  <div className="mb-6 text-left">
                    <h2 className="text-2xl font-black text-[var(--color-primary-dark)] mb-1.5">
                  ...
                  <div className="relative flex py-5 items-center">
                    ...
                    <span className="flex-shrink mx-4 text-[var(--color-muted)] text-[9px] font-mono uppercase tracking-widest">
                      Or continue with
                    </span>
                    <div className="flex-grow border-t border-[var(--color-border)]" />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] hover:bg-[var(--color-border)]/20 text-[var(--color-heading)] text-xs font-semibold transition-all cursor-pointer active:scale-95"
                    >
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] hover:bg-[var(--color-border)]/20 text-[var(--color-heading)] text-xs font-semibold transition-all cursor-pointer active:scale-95"
                    >
                      <svg className="h-4.5 w-4.5 fill-current text-[var(--color-heading)] shrink-0" viewBox="0 0 24 24">
                    ...
                    {flowStep !== "phone" && (
                      <button
                        ...
                        className="col-span-2 w-full flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] hover:bg-[var(--color-border)]/20 text-[var(--color-primary-dark)] text-xs font-semibold transition-all cursor-pointer active:scale-95 mt-1.5"
                      >
